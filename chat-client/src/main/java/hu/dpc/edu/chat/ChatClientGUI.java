 ...
 * @author IQJB
 */
public class ChatClientGUI extends javax.swing.JFrame implements ChatView, MessageListener{
    ...
    private void sendMessage() {
        controller.sendMessage(new BroadcastMessage(userTF.getText(), messageTF.getText()));
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChatModel model = new ChatModelNetworkImpl();
                ChatController controller = new ChatControllerImpl(model);
                ChatClientGUI view = new ChatClientGUI(controller);
                model.addMessageListener(view);
    ...
    public void printReceivedMessage(Message message) {
        messagesTA.append(message.toString() + "\n");
    }
